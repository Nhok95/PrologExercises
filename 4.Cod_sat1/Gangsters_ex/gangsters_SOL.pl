...
createWindow(H1,H2,K):- H2 is H1 + K.
...
%   2. consecutive-G-H means: gangster G starts working consecutively at hour H.

writeClauses(K):- 
  initClauseGeneration,
  eachHourEachGangsterAtMostOneTask,
  eachGangsterAtMostKHours(K),
  eachGangsterRestHourBeetweenJobs,
  allTasksAreDone,
  true,!.
